...
export default {
  ...
  methods:{
	...
	      this.$axios({
	        method:"post",
	        url: ' http://zl323.free.idcfengye.com/calendarSelectAll?size=5&np='+start,
	        data: {
	//           np1:1,
			//   size1:5
	        }//向后端传递参数
	...
	      this.$axios({
	        method:"post",
	        url: ' http://zl323.free.idcfengye.com/calendarDelete?id='+id,
	        data: {
	//           np1:1,
			//   size1:5
	        }//向后端传递参数
	...
	      })
		// axios.delete(' http://zl323.free.idcfengye.com/calendarDelete?id='+id).then(function(response){
		// 	vue.calendarSelectAll(1);
		// });
	},
	...
	calendarInsertUpdate(){
		...
		if(this.tblcal.id>0){
			//update
			url=' http://zl323.free.idcfengye.com/calendarUpdate?id='+this.tblcal.id;
		}
		else{
			//insert
			url=' http://zl323.free.idcfengye.com/calendarInsert';
		}
		//axios提交
	      this.$axios({
	        method:"post",
